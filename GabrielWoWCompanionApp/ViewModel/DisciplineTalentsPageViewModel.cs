...
public partial class DisciplineTalentsPageViewModel : BaseTalentViewModel
{
    public DisciplineTalentsPageViewModel(TalentProfileService talentProfileService)
    {
        try
        {
            Talents = TalentService.GetDisciplineTalents();         // Initialize the collection of talents
            ...
            PageSpecilization = Specilization.Discipline;
